    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  href="{{ route('contact.index') }}" style="color: #fff; margin-right:20px" class="btn btn-info btn-sm">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="total_employee" class="col-md-3 col-form-label text-md-right">{{ __('Total Employee') }}</label>
                             <div class="col-md-8">
                                <input id="total_employee" type="total_employee" class="form-control{{ $errors->has('total_employee') ? ' is-invalid' : '' }}" name="total_employee" value="{{ old('total_employee') }}">
                        ...
                        <div class="form-group row">
                            <label for="annual_revenue" class="col-md-3 col-form-label text-md-right">{{ __('Annual Revenue') }}</label>
                             <div class="col-md-8">
                                <input id="annual_revenue" type="annual_revenue" class="form-control{{ $errors->has('annual_revenue') ? ' is-invalid' : '' }}" name="annual_revenue" value="{{ old('annual_revenue') }}">
