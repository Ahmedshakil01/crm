    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="page-header" style="border:none; mark">
                            <h3 class="page-title">Customer Order Report List</h3>
                            <li>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Customer Order Report List</li>
                        </ol>
                    </div>
...
<script>
    ...
    function ajaxCustomer(key)
    {
        ...
        var surl = '/administration/order/ajaxfilter/';
        $.ajax({
            type: "GET",
            url: surl,
            data: {'keys':key},
