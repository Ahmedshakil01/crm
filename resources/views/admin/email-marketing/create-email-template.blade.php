...
@section('title') New Eamail Template - aleshamart @endsection
@section('content')
    <style>
        .required{
            color:red;
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="page-header" style="border:none">
                            <h3 class="page-title">Create New Email Template</h3>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-0" style="margin-top: 30px;margin-bottom: 30px;">
                    <table class="table table-striped projects">
                        <form method="POST" action="{{ route('admin.email.template.store') }}" enctype="multipart/form-data">
                            @csrf
