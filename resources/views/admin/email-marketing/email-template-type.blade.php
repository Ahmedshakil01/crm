...
@section('title') Email Template Type List - aleshamart @endsection
@section('content')
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="page-header" style="border:none">
                            <h3 class="page-title">Email Template Type List</h3>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Template Type List</li>
                        </ol>
                    </div>
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class=""><a  href="{{ route('admin.create-email-template.type') }}" style="color:#fff; margin-right:20px" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create Email Template Type</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <tr id="tablerow<?php echo $notificationsType->id;?>" class="tablerow">
                                    ...
                                    <td align="center" valign="top">
                                        <div style="width:50%; float:left">
                                            <a href="{{ route('admin.email-template.type.edit', $notificationsType->id) }}" class="btn btn-warning" style="font-size: 12px; float:left; padding:3px 5px"><i class="fa fa-edit"></i></a></div>
                                        <div style="width:50%; float:left"><button type="button" class="btn btn-danger" style="font-size: 12px; float:left; padding:3px 5px" onclick="deleteSingle('<?php echo $notificationsType->id;?>','/administration/masterdelete','email_template_types')"><i class="fa fa-trash"></i></button></div>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
