          ...
          <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h3 class="page-title">Rating Edit</h3>
                    </div>
                    </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit - {{ $lead_rating->title }}</li>
                    </ol>
                </div>
              <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
            ...
            <div class="card">
              ...
              <div class="card-body p-0" style="margin-top: 30px;margin-bottom: 30px;">
                <table class="table table-striped projects">
                    {!! Form::model($lead_rating, ['route'=>['lead_rating.update', $lead_rating->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal', 'id="tabs"']) !!}
                   <div class="col-sm-12">
                        	 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        value="{{ $lead_rating->name }}" required autofocus>
							 ...
							 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="details" type="text" class="form-control ckeditor" name="details" autofocus>{{ $lead_rating->details }}</textarea>
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="status" class="form-control">
                                        	<option value="{{ $lead_rating->status }}">{{ $lead_rating->status }}</option>
