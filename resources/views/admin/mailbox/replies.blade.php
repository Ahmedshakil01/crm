...
@section('title') Replies Ticket - Aleshamart @endsection
		...
		<div class="row mb-2">
		  <div class="col-sm-6">
			<div class="page-header" style="border:none">
			  <h3 class="page-title">Replies Ticket</h3>
		  </div>
		  ...
		  <div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
			  ...
			  <li class="breadcrumb-item active">Sent List</li>
			</ol>
		  </div>
		  @if($permission->can('support.multipleDelete') || $permission->can('support.compose') || $permission->can('support.draftmail') || $permission->can('support.inbox'))
		  <div class="col-sm-12">
			<ol class="breadcrumb float-sm-right">
			...
			@if($permission->can('support.inbox'))
			  <li class=""><a  href="{{ route('admin.mailbox') }}" style="color:#fff; margin-right:20px" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Inbox Ticket</a></li>
			@endif
			</ol>
		  </div>
		  @endif
								...
								<td colspan="6" style="padding:0;">
									<div class="lists">
										<a href="{{ route('admin.maildetails',$mails->id)}}">
											...
											@endif
												<td width="13%" style="background:none; border:none;font-weight:{{ $fontweight }};">{{ $mails->receiver_type }}</td>
												<td width="25%" style="background:none; border:none;font-weight:{{ $fontweight }};">#{{ $mails->mail_id}}</td>
												<td width="28%" style="background:none; border:none;font-weight:{{ $fontweight }};">{{$mails->mailBoxes->subject}}</td>
