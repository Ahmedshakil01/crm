...
@section('title') Email Type List - aleshamart @endsection
@section('content')
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div class="page-header" style="border:none">
                            <h3 class="page-title">View Send list</h3>
                        </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Email Marketing Type List</li>
                        </ol>
                    </div>
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                ...
                <div class="card-body p-0">
                    <form id="form_check">
                        <table id="responsive-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            @foreach($notificationsTypes as $notificationsType)
                                <?php $i++;
                                if($notificationsType->status!="" && $notificationsType->status==1){
                    ...
                    <i class="fa fa-times"></i> </span>';
                                ...
                                <tr id="tablerow<?php echo $notificationsType->id;?>" class="tablerow">
                                    ...
                                    {{-- <td align="center" valign="top"><input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>" value="{{ $notificationsType->id }}" /></td> --}}
                                    <td align="center" valign="top">{{ $notificationsType->name }}</td>
                                    <td><b>@if($notificationsType->status == 1) <span class="btn-sm btn-success">Active</span> @else <span class="btn-sm btn-warning">Inactive</span>  @endif</td>
