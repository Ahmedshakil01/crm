      ...
      <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h3 class="page-title">Create New Source</h3>
                </div>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">New Source</li>
                </ol>
            </div>
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
        ...
        <div class="card">
          ...
          <div class="card-body p-0" style="margin-top: 30px;margin-bottom: 30px;">
            <table class="table table-striped projects">
                <form method="POST" action="{{ route('ticket_status.store') }}" enctype="multipart/form-data" id="tabs">
                    @csrf
                    <div class="col-sm-12">
