            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit - {{ $ticket_status->title }}</li>
                    </ol>
                </div>
              <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class=""><a  href="{{ route('ticket_status.index') }}" style="color: #fff; margin-right:20px" class="btn btn-info btn-sm"><i class="fa fa-list"></i> Source List</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body p-0" style="margin-top: 30px;margin-bottom: 30px;">
                <table class="table table-striped projects">
                    {!! Form::model($ticket_status, ['route'=>['ticket_status.update', $ticket_status->id], 'files' => true, 'method'=>'PATCH', 'class'=>'form-horizontal', 'id="tabs"']) !!}
                   <div class="col-sm-12">
                        	 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        value="{{ $ticket_status->name }}" required autofocus>
							 ...
							 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="details" type="text" class="form-control ckeditor" name="details" autofocus>{{ $ticket_status->details }}</textarea>
                             ...
                             <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="status" class="form-control">
                                        	<option value="{{ $ticket_status->status }}">{{ $ticket_status->status }}</option>
